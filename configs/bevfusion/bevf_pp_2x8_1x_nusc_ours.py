_base_ = [
    ...
    '../_base_/datasets/nusc_pp_wo_multi_sweeps.py',  # use the keyframes only
...
load_from = 'work_dirs/hv_pointpillars_secfpn_sbn-all_4x8_2x_nus-3d_e24.pth'  #####load lidar stream
